package com.firstProject.back.pojo;
...
public class Person {
    ...
    public Person(Long id, String name, Long born, Set<Movie> actedInMovie, Set<Movie> producedMovie, Set<Movie> directedMovie, Set<Movie> wroteMovie, Set<Movie> reviewedMovie) {
        this.id = id;
        this.name = name;
        this.born = born;
        this.actedInMovie = actedInMovie;
